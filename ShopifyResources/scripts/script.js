...
function validiateInput(){
    ...
    if (atIndex<1 || dotIndex<atIndex+2 || dotIndex+2>=input.length) {  /* validiates the input */
        ...
        $("#subtitle").text("If" + " " + input + " " + "exists in our database, you should hear from us soon."); 
        /* hides the textbox */
        $(".email").hide();
